...
def create_auto_scaling_group(template_id, asg_name, vpc_zone_identifier, min_size, max_size, desired_capacity, target_group_arns, region):
...
create_auto_scaling_group(template_id, asg_name, vpc_zone_identifier, min_size, max_size, desired_capacity, target_group_arns, region)
